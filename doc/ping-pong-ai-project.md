...
```mermaid
graph LR
    I("輸入層<br/>[5維]<br/>ball_x, ball_y<br/>vel_x, vel_y<br/>paddle_x")
    
    H1("隱藏層1<br/>[64 neurons]<br/>ReLU")
    
    H2("隱藏層2<br/>[64 neurons]<br/>ReLU")
    
    H3("隱藏層3<br/>[32 neurons]<br/>ReLU")
    
    O("輸出層<br/>[3維 Q-values]<br/>左移 / 不動 / 右移")
    
    D("決策<br/>argmax(Q)<br/>選擇最優動作")

    I -->|全連接<br/>W1 5×64| H1
    H1 -->|全連接<br/>W2 64×64| H2
    H2 -->|全連接<br/>W3 64×32| H3
    H3 -->|全連接<br/>Wout 32×3| O
    O -->|貪心選擇| D

    style I fill:#e3f2fd,stroke:#1976d2,stroke-width:3px,color:#000
    style H1 fill:#fff9c4,stroke:#f57f17,stroke-width:2px,color:#000
    style H2 fill:#fff9c4,stroke:#f57f17,stroke-width:2px,color:#000
    style H3 fill:#fff9c4,stroke:#f57f17,stroke-width:2px,color:#000
    style O fill:#c8e6c9,stroke:#388e3c,stroke-width:3px,color:#000
...
| 層級 | 維度 | 說明 |
|:-----|:-----|:-----|
| 輸入層 | 5 | 遊戲狀態特徵：球位置、球速度、拍位置 |
| 隱藏層1 | 64 | 特徵提取與基礎表示，ReLU 激活 |
| 隱藏層2 | 64 | 特徵融合與複雜關係捕捉，ReLU 激活 |
| 隱藏層3 | 32 | 特徵壓縮與高層抽象表示，ReLU 激活 |
| 輸出層 | 3 | 三個動作的 Q 值估計 |
| 決策層 | 1 | 通過 argmax 選擇 Q 值最大的動作 |
